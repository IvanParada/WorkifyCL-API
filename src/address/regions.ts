export const regions = [
    ...
    },
    {
      ...
      communes: ["Chillán", "Chillán Viejo", "Quillón", "Bulnes", "San Ignacio", "El Carmen", "Pinto", "Pemuco", "Yungay", "San Carlos", "Coihueco", "San Fabián", "San Nicolás", "Ñiquén", "Quirihue", "Cobquecura", "Ninhue", "Treguaco", "Coelemu", "Portezuelo", "Ránquil"]
    },
    {
    ...
    },
    {
      ...
      communes: ["Temuco", "Padre Las Casas", "Carahue", "Cunco", "Curarrehue", "Freire", "Galvarino", "Gorbea", "Lautaro", "Loncoche", "Melipeuco", "Nueva Imperial", "Perquenco", "Pitrufquén", "Puerto Saavedra", "Teodoro Schmidt", "Toltén", "Vilcún", "Villarrica", "Cholchol"]
    },
    {
